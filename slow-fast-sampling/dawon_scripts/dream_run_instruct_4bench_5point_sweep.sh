...
# Usage:
#   bash dawon_scripts/dream_run_instruct_4bench_5point_sweep.sh [GPU_IDS] [MAIN_PORT]
# Example:
#   bash dawon_scripts/dream_run_instruct_4bench_5point_sweep.sh 0 29510
GPU_IDS="${1:-1}"
MAIN_PORT="${2:-29510}"
...
OUTPUT_ROOT="${PROJECT_ROOT}/dawon_outputs/dream_instruct_4bench_5point_sweep"
