...
class LLaDA(TemplateLM):
    ...
    def _write_forward_stats(
        ...
        *,
        ...
        payload = {
            ...
            "avg_forward_passes": avg_per_item,
    ...
    def generate_until(self, requests: List[Instance]) -> List[str]:
        ...
        for batch in ds.iter(self.batch_size):
            ...
            out, batch_nfe = sampler.generate(context_enc, attn_masks)
            total_forward_passes += float(batch_nfe)
